...
License  : MIT
Requires: lua53-bin = %{version}-%{release}
Requires: lua53-lib = %{version}-%{release}
Requires: lua53-man = %{version}-%{release}
...
%package bin
Summary: bin components for the lua53 package.
Group: Binaries

%description bin
bin components for the lua53 package.


%package dev
Summary: dev components for the lua53 package.
Group: Development
Requires: lua53-lib = %{version}-%{release}
Requires: lua53-bin = %{version}-%{release}
Provides: lua53-devel = %{version}-%{release}
Requires: lua53 = %{version}-%{release}

%description dev
dev components for the lua53 package.


%package lib
Summary: lib components for the lua53 package.
Group: Libraries

%description lib
lib components for the lua53 package.


%package man
Summary: man components for the lua53 package.
Group: Default

%description man
man components for the lua53 package.


%package staticdev
Summary: staticdev components for the lua53 package.
Group: Default
Requires: lua53-dev = %{version}-%{release}

%description staticdev
staticdev components for the lua53 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613594311
